...
export namespace Prisma {
  ...
  */
  ...
  export type QueryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "username" | "query" | "response" | "createdAt", ExtArgs["result"]["query"]>
  ...
  interface QueryFieldRefs {
    ...
    readonly username: FieldRef<"Query", 'String'>
  ...
  export type QueryWhereInput = {
    ...
    username?: StringNullableFilter<"Query"> | string | null
    query?: StringFilter<"Query"> | string
    response?: StringFilter<"Query"> | string
  ...
  export type QueryScalarWhereWithAggregatesInput = {
    ...
    username?: StringNullableWithAggregatesFilter<"Query"> | string | null
    query?: StringWithAggregatesFilter<"Query"> | string
    response?: StringWithAggregatesFilter<"Query"> | string
